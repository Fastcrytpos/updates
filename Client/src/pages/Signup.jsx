...
import backgroundimm from "../assets/rowan-heuvel-ezivJo9SzDQ-unsplash.jpg"
...
function Signup() {
  ...
  return (
    <div style={{backgroundImage:backgroundimm}}
    ...
    className="flex items-center justify-center h-screen">
      <div className="bg-white rounded-lg shadow-lg w-80 flex flex-col items-center">
        ...
        <form className="px-8 pb-8 w-full flex flex-col">
          ...
          <input type="email" id="email" name="email" className="w-full mb-4 p-2 border rounded-md" />
